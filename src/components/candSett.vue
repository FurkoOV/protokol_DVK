        ...
        <div class="mdl-grid">
            ...
            <div class="mdl-cell--10-col cellbuttop">
                ...
                <span style="font-size:0.8em; margin-left: 15px">
                    <a @click="show_info"> <i class="material-icons" title="Як це працює?">help_outline</i> </a>
                </span>
